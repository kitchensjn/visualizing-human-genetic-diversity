...
geovar_code_counts.to_csv("assets/Dryad/new_1kg_nyc_hg38_filt_total.biallelic_snps.pops.ncat_000_001_005_010.geodist.total.txt", sep=' ', header=False, index=False)
